...
const db =
  "mongodb+srv://Getange:zaki6971@apple-plant-disease-cla.ujldn5o.mongodb.net/Disease?retryWrites=true&w=majority&appName=apple-plant-disease-classification";
mongoose
  .connect(db)
  .then(() => {
...
const disease = JSON.parse(
  fs.readFileSync(`${__dirname}/diseaseData.json`, "utf8"),
);
